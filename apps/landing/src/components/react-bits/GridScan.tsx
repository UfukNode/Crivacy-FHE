...
// NOTE: Upstream react-bits GridScan ships with an optional webcam
// face-tracking mode via face-api.js. Crivacy uses this component only
// as a passive animated background (waitlist confirmation page), so the
// face-api import, the model-loading useEffect, and the getUserMedia
// detection loop have been removed. Mouse-parallax still works.
