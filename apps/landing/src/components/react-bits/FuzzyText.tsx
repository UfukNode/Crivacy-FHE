...
// FuzzyText — ported from reactbits.dev (JS source supplied by user).
// Canvas-based fuzzy/glitch text that displaces rows (or columns) of
// pixels by a random offset each frame. `enableHover` bumps the
// displacement amplitude while the pointer is over the text bounds.
// Original: https://reactbits.dev/text-animations/fuzzy-text
