...
export function VideoText({
  ...
  // NOTE: Use `createElement` instead of <Component> JSX. @react-three/fiber v9
  // globally augments JSX in a way that collapses polymorphic `as` patterns'
  // children type to `never`. createElement sidesteps that entirely.
