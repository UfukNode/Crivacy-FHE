            ...
            return (
              ...
              >
                <div className="absolute top-1/2 -left-4 -translate-y-1/2 opacity-0 transition-opacity group-hover:opacity-100 focus-within:opacity-100">
                  {line.kind !== "hunk" && (
                    <Tooltip>
                      <TooltipTrigger render={<Button size="icon" variant="secondary" aria-label="Add inline comment" className="h-5 w-5 rounded-full shadow-sm" onClick={() => setOpenThreadAt(isOpen ? null : idx)} />}><MessageSquarePlus className="h-3 w-3" /></TooltipTrigger>
